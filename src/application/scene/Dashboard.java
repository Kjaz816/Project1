...
public class Dashboard {
	  ...
	  @FXML private Button button_main_notes;
	  @FXML private Button button_main_todo;
	  @FXML private Button button_main_drawboard;
	  @FXML private Button button_main_timer;
